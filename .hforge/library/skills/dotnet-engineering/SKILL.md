...
- `.hforge/library/rules/dotnet/README.md`
- `.hforge/library/rules/dotnet/coding-style.md`
- `.hforge/library/rules/dotnet/patterns.md`
- `.hforge/library/rules/dotnet/testing.md`
- `.hforge/library/rules/dotnet/security.md`
- `.hforge/templates/workflows/implement-dotnet-change.md`
- `.hforge/library/knowledge/seeded/dotnet/docs/overview.md`
- `.hforge/library/knowledge/seeded/dotnet/docs/frameworks.md`
- `.hforge/library/knowledge/seeded/dotnet/docs/review-checklist.md`
- `.hforge/library/knowledge/seeded/dotnet/examples/`
...
- consult `.hforge/library/knowledge/seeded/dotnet/docs/review-checklist.md` before finalizing a patch or design note
...
- `.hforge/library/skills/dotnet-engineering/references/repo-exploration.md`
- `.hforge/library/skills/dotnet-engineering/references/output-templates.md`
- `.hforge/library/skills/dotnet-engineering/references/agent-patterns.md`
- `.hforge/library/skills/dotnet-engineering/references/debugging-playbook.md`
- `.hforge/library/skills/dotnet-engineering/references/architecture-and-di.md`
- `.hforge/library/skills/dotnet-engineering/references/aspnet-and-efcore.md`
- `.hforge/library/skills/dotnet-engineering/references/testing-and-performance.md`
- `.hforge/library/skills/dotnet-engineering/references/cloud-native-and-aspire.md`
- `.hforge/library/skills/dotnet-engineering/references/examples.md`
