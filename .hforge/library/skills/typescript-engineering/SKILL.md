...
- `.hforge/library/rules/common/README.md`
- `.hforge/library/rules/common/coding-style.md`
- `.hforge/library/rules/common/patterns.md`
- `.hforge/library/rules/common/testing.md`
- `.hforge/library/rules/common/security.md`
- `.hforge/library/rules/typescript/README.md`
- `.hforge/library/rules/typescript/coding-style.md`
- `.hforge/library/rules/typescript/patterns.md`
- `.hforge/library/rules/typescript/testing.md`
- `.hforge/library/rules/typescript/security.md`
- `.hforge/templates/workflows/implement-typescript-change.md`
- `.hforge/library/knowledge/seeded/typescript/docs/overview.md`
- `.hforge/library/knowledge/seeded/typescript/docs/frameworks.md`
- `.hforge/library/knowledge/seeded/typescript/docs/review-checklist.md`
- `.hforge/library/knowledge/seeded/typescript/examples/`
...
- consult `.hforge/library/knowledge/seeded/typescript/docs/review-checklist.md` before finalizing a patch or design note
...
- `.hforge/library/skills/typescript-engineering/references/repo-exploration.md`
- `.hforge/library/skills/typescript-engineering/references/output-templates.md`
- `.hforge/library/skills/typescript-engineering/references/agent-patterns.md`
- `.hforge/library/skills/typescript-engineering/references/debugging-playbook.md`
- `.hforge/library/skills/typescript-engineering/references/type-system-patterns.md`
- `.hforge/library/skills/typescript-engineering/references/tsconfig-and-build.md`
- `.hforge/library/skills/typescript-engineering/references/frontend-and-backend-patterns.md`
- `.hforge/library/skills/typescript-engineering/references/runtime-validation-and-boundaries.md`
- `.hforge/library/skills/typescript-engineering/references/workspace-and-monorepo.md`
- `.hforge/library/skills/typescript-engineering/references/examples.md`
