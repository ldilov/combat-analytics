...
- `.hforge/library/skills/api-contract-review/references/http-contract-checklist.md`
- `.hforge/library/skills/api-contract-review/references/schema-compatibility.md`
- `.hforge/library/skills/api-contract-review/references/event-and-async-contracts.md`
- `.hforge/library/skills/api-contract-review/references/protobuf-and-buf.md`
- `.hforge/library/skills/api-contract-review/references/style-and-linting.md`
- `.hforge/library/skills/api-contract-review/references/review-template.md`
- `.hforge/library/skills/api-contract-review/references/examples.md`
