...
- `.hforge/library/knowledge/structured/swift/docs/`
- `.hforge/library/knowledge/structured/swift/examples/`
...
- consult `.hforge/library/knowledge/structured/swift/docs/review-checklist.md`
