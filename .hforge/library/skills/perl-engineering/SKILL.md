...
- `.hforge/library/knowledge/structured/perl/docs/`
- `.hforge/library/knowledge/structured/perl/examples/`
...
- consult `.hforge/library/knowledge/structured/perl/docs/review-checklist.md`
