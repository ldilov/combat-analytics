...
- `.hforge/library/knowledge/structured/python/docs/`
- `.hforge/library/knowledge/structured/python/examples/`
...
- consult `.hforge/library/knowledge/structured/python/docs/review-checklist.md`
...
- `.hforge/library/skills/python-engineering/references/repo-exploration.md`
- `.hforge/library/skills/python-engineering/references/output-templates.md`
- `.hforge/library/skills/python-engineering/references/agent-patterns.md`
- `.hforge/library/skills/python-engineering/references/debugging-playbook.md`
- `.hforge/library/skills/python-engineering/references/ecosystem-guide.md`
- `.hforge/library/skills/python-engineering/references/async-and-concurrency.md`
- `.hforge/library/skills/python-engineering/references/testing-and-quality.md`
- `.hforge/library/skills/python-engineering/references/examples.md`
