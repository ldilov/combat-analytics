...
- `.hforge/library/skills/cloud-architect/references/repo-exploration.md`
- `.hforge/library/skills/cloud-architect/references/output-templates.md`
- `.hforge/library/skills/cloud-architect/references/agent-patterns.md`
- `.hforge/library/skills/cloud-architect/references/debugging-playbook.md`
- `.hforge/library/skills/cloud-architect/references/distributed-systems.md`
- `.hforge/library/skills/cloud-architect/references/platform-and-deployment.md`
- `.hforge/library/skills/cloud-architect/references/reliability-security-cost.md`
- `.hforge/library/skills/cloud-architect/references/examples.md`
