...
- `.hforge/library/knowledge/seeded/typescript/docs/frameworks.md` when the repository shares the wider Node, React, or Vite ecosystem
...
- `.hforge/library/skills/javascript-engineering/references/repo-exploration.md`
- `.hforge/library/skills/javascript-engineering/references/output-templates.md`
- `.hforge/library/skills/javascript-engineering/references/agent-patterns.md`
- `.hforge/library/skills/javascript-engineering/references/debugging-playbook.md`
- `.hforge/library/skills/javascript-engineering/references/ecosystem-guide.md`
- `.hforge/library/skills/javascript-engineering/references/node-service-patterns.md`
- `.hforge/library/skills/javascript-engineering/references/browser-and-bundler-patterns.md`
- `.hforge/library/skills/javascript-engineering/references/package-contracts.md`
- `.hforge/library/skills/javascript-engineering/references/testing-and-debugging.md`
- `.hforge/library/skills/javascript-engineering/references/examples.md`
