...
- `.hforge/library/skills/repo-onboarding/references/output-template.md`
- `.hforge/library/skills/repo-onboarding/references/discovery-checklist.md`
- `.hforge/library/skills/repo-onboarding/references/repo-archetypes.md`
- `.hforge/library/skills/repo-onboarding/references/ownership-and-health-signals.md`
- `.hforge/library/skills/repo-onboarding/references/command-discovery.md`
- `.hforge/library/skills/repo-onboarding/references/monorepo-signals.md`
- `.hforge/library/skills/repo-onboarding/references/examples.md`
