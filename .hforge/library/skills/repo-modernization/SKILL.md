...
- `.hforge/library/skills/repo-modernization/references/modernization-layers.md`
- `.hforge/library/skills/repo-modernization/references/strangler-and-seams.md`
- `.hforge/library/skills/repo-modernization/references/dependency-and-build-modernization.md`
- `.hforge/library/skills/repo-modernization/references/safety-rails.md`
- `.hforge/library/skills/repo-modernization/references/automation-candidates.md`
- `.hforge/library/skills/repo-modernization/references/roadmap-template.md`
- `.hforge/library/skills/repo-modernization/references/examples.md`
