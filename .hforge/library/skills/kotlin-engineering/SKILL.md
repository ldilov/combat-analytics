...
- `.hforge/library/knowledge/structured/kotlin/docs/`
- `.hforge/library/knowledge/structured/kotlin/examples/`
...
- consult `.hforge/library/knowledge/structured/kotlin/docs/review-checklist.md`
