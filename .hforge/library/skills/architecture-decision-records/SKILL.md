...
- `.hforge/library/skills/architecture-decision-records/references/adr-template.md`
- `.hforge/library/skills/architecture-decision-records/references/decision-rubric.md`
- `.hforge/library/skills/architecture-decision-records/references/madr-style-guide.md`
- `.hforge/library/skills/architecture-decision-records/references/adr-anti-patterns.md`
- `.hforge/library/skills/architecture-decision-records/references/examples.md`
