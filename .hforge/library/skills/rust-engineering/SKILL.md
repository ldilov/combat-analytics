...
- `.hforge/library/knowledge/structured/rust/docs/`
- `.hforge/library/knowledge/structured/rust/examples/`
...
- consult `.hforge/library/knowledge/structured/rust/docs/review-checklist.md`
