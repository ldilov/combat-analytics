...
- `.hforge/library/skills/parallel-worktree-supervisor/references/task-sharding-rules.md`
- `.hforge/library/skills/parallel-worktree-supervisor/references/worktree-operations.md`
- `.hforge/library/skills/parallel-worktree-supervisor/references/stacked-diffs-and-review.md`
- `.hforge/library/skills/parallel-worktree-supervisor/references/merge-readiness.md`
- `.hforge/library/skills/parallel-worktree-supervisor/references/output-template.md`
- `.hforge/library/skills/parallel-worktree-supervisor/references/examples.md`
