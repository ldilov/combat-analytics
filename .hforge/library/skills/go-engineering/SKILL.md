...
- `.hforge/library/knowledge/structured/go/docs/`
- `.hforge/library/knowledge/structured/go/examples/`
...
- consult `.hforge/library/knowledge/structured/go/docs/review-checklist.md`
