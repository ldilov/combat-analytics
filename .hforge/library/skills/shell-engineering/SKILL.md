...
- `.hforge/library/knowledge/structured/shell/docs/`
- `.hforge/library/knowledge/structured/shell/examples/`
...
- consult `.hforge/library/knowledge/structured/shell/docs/review-checklist.md`
