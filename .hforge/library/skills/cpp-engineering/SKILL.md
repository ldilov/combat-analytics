...
- `.hforge/library/knowledge/structured/cpp/docs/`
- `.hforge/library/knowledge/structured/cpp/examples/`
...
- consult `.hforge/library/knowledge/structured/cpp/docs/review-checklist.md`
