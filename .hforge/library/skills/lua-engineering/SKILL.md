...
- `.hforge/library/rules/lua/README.md`
- `.hforge/library/rules/lua/coding-style.md`
- `.hforge/library/rules/lua/patterns.md`
- `.hforge/library/rules/lua/testing.md`
- `.hforge/library/rules/lua/security.md`
- `.hforge/templates/workflows/implement-lua-change.md`
- `.hforge/library/knowledge/seeded/lua/docs/overview.md`
- `.hforge/library/knowledge/seeded/lua/docs/frameworks.md`
- `.hforge/library/knowledge/seeded/lua/docs/review-checklist.md`
- `.hforge/library/knowledge/seeded/lua/examples/`
...
- consult `.hforge/library/knowledge/seeded/lua/docs/review-checklist.md` before finalizing a patch or design note
...
- `.hforge/library/skills/lua-engineering/references/repo-exploration.md`
- `.hforge/library/skills/lua-engineering/references/output-templates.md`
- `.hforge/library/skills/lua-engineering/references/agent-patterns.md`
- `.hforge/library/skills/lua-engineering/references/debugging-playbook.md`
- `.hforge/library/skills/lua-engineering/references/language-idioms.md`
- `.hforge/library/skills/lua-engineering/references/runtime-profiles.md`
- `.hforge/library/skills/lua-engineering/references/neovim-and-editor-patterns.md`
- `.hforge/library/skills/lua-engineering/references/openresty-patterns.md`
- `.hforge/library/skills/lua-engineering/references/game-and-addon-patterns.md`
- `.hforge/library/skills/lua-engineering/references/debugging-and-testing.md`
- `.hforge/library/skills/lua-engineering/references/tooling-and-quality.md`
- `.hforge/library/skills/lua-engineering/references/examples.md`
