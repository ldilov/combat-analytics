...
- `.hforge/library/manifests/catalog/compatibility-matrix.json` is generated from targets,
  profiles, hooks, workflows, skills, languages, and framework metadata
- `.hforge/library/manifests/catalog/seeded-knowledge-files.json` is generated from the seeded
  archive mapping
- `.hforge/library/manifests/catalog/engineering-assistant-import-inventory.json` is authored
  governance data for the engineering-assistant port, not a generated artifact
- `.hforge/library/docs/authoring/engineering-assistant-port.md` is curated provenance for the
  engineering-assistant import, not a runtime skill entrypoint
- `.hforge/library/manifests/catalog/enhanced-skill-import-inventory.json` is authored
  governance data for imported skill packs, not a generated artifact
- `.hforge/library/docs/authoring/enhanced-skill-import.md` is curated provenance for imported
