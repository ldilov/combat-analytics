...
- when working inside the Harness Forge source repository itself, the authored source-of-truth surfaces still live in `.hforge/library/skills/`, `.hforge/library/rules/`, `.hforge/library/knowledge/`, `templates/`, `.hforge/library/manifests/`, `.hforge/library/targets/`, and `src/`
